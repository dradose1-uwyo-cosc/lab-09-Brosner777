...
class Pizzeria:
    ...
    def get_price(self, pizza):
        ...
        toppings_price = pizza.get_amount_of_toppings() * Pizzeria.price_per_topping
    ...
    def get_receipt(self, pizza):
        ...
        print("\nYou ordered a {}\" pizza with {} sauce and the following toppings:".format(pizza.get_size(), pizza.get_sauce()))
...
while True:
    action = input("Would you like to place an order? Type 'yes' to order or 'exit' to quit\n").strip().lower()
    if action == "exit":
        break
    elif action == "yes":
